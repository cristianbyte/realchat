    ...
    return (
        <div className="navbar">
            ...
            onMouseEnter={enableScrolling} >
                <Contact onClick={() => activateContact(1)} active={activeContact === 1} name='Me' picture={Me}   state='avalible' message='Hola ¿Como estás?, tenia tiempo sin saber de ti' notification='1'/>
                <Contact onClick={() => activateContact(2)} active={activeContact === 2} name='Nano' picture={Nin} state='busy' message='Tengo una nueva misión' notification='3'/>
                ...
                <Contact onClick={() => activateContact(4)} active={activeContact === 4} name='Melissa' picture={Future} state='text-me' message='Everything is possible, the only limit is your mind.' notification='1'/>
            </div>
        </div>
    )
}